...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-xxxl navbar-light overflow-hidden">
                <div class="container-fluid justify-content-space-around">
                    ...
                    <button
                        class="btn btn-primary ms-auto buttongold"
                        id="btn-titip"
                    >
                        Titip&Jual
                    </button>
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-3 mb-4">
                ...
                <div class="col">
                    <div class="card h-100">
                        <img
                            src="./images/Cencen Property Logo (Sosmed).png"
                            class="card-img-top"
                            alt="..."
                        />
                        <!--Hot list-->
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination mb-4 justify-content-center">
                    ...
                    <li class="page-item">
                        <a class="page-link" href="#" style="color: #bc9c22"
                            >1</a
                        >
                    </li>
                    <li class="page-item">
        ...
        <footer
            ...
            style="
                background-image: url(https://source.unsplash.com/800x800?home);
            "
        >
