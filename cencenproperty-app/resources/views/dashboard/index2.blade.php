          ...
          <div class="row ps-md-5">
            ...
            <div class="col-md-5 ps-0 pe-3 me-5 ms-2">
                ...
                <div class="input-group mb-3">
                  ...
                  <button class="btn btn-secondary" type="submit" id="search"><i class="fa-solid fa-magnifying-glass" style="color: #ffffff;"></i></button>
                </div>
              </form>
              </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-9 border border-3 rounded px-3 py-2 ms-md-4">
              ...
              <div class="d-flex inline-flex gap-2">
                <button class="btn btn-secondary btn-sm mt-1" type="submit"><a href="/dashboard/posts/{{ $post->id }}/edit" class="text-decoration-none text-white"><i class="fa-solid fa-pen-to-square"></i></a></button>
