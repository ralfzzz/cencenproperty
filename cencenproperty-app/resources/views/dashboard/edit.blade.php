        ...
        <form action="/dashboard/posts/{{ $posts->id }}" method="POST" class="mb-5" enctype="multipart/form-data">
          ...
          <div class="container-fluid mb-3">
            <div class="row">
              ...
              <div class="col-md-5">
                <input type="text" class="form-control @error('kota_kabupaten') is-invalid @enderror" id="kota_kabupaten" name="kota_kabupaten" value="{{ old('kota_kabupaten', $posts->kota_kabupaten) }}">
          ...
          <div class="container-fluid mb-3">
            <div class="row">
              ...
              <div class="col-md-5">
                  <div class="d-grid">
                    <button type="submit" class="btn btn-secondary"><strong class="text-white">Edit</strong></button>
                  </div>
              </div>
            </div>
          </div>
